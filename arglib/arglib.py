...
class TrainArgs(BaseArgs):
    ...
    def add_args(self):
        ...
        self.parser.add_argument('--celeba_path' , type=Path)
    ...
    def process(self):
        ...
        self.args.weights_dir_for_test = self.args.results_dir.joinpath('weights_for_test')
        self.args.weights_dir_for_test.mkdir(exist_ok=True)
...
class TestArgs(BaseArgs):
    ...
    def add_args(self):
        ...
        self.parser.add_argument('--epochnum', type=Path)
